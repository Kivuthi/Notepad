<header class="flex items-center justify-between bg-gradient-to-r from-pink-200 to-red-300 shadow-md px-6 py-9">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="relative group">
            <button class="flex items-center space-x-2 focus:outline-none">
                <img src="#" class="w-8 h-8 rounded-full border" alt="User">
            ...
            <div class="absolute right-0 mt-2 bg-white shadow-lg rounded-md py-2 w-40 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                ...
                <hr>
                <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50">Logout</a>
            </div>
        </div>
    </div>
</header>
