<aside id="sidebar"
    class="fixed md:relative bg-white w-64 shadow-xl h-screen p-4 space-y-6 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">

    <div class="flex items-center space-x-3 px-3">
        <img src="https://i.pravatar.cc/50" alt="User" class="w-10 h-10 rounded-full">
        <div>
            <h2 class="text-gray-800 font-semibold">Dennis Musyoka</h2>
            <p class="text-gray-400 text-sm">Chairman</p>
        </div>
    </div>
